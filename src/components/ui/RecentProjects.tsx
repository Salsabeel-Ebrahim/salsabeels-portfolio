  ...
  return (
    <div className='py-20' id='projects'>
        ...
        <div className='grid gap-x-8 justify-center items-center flex-wrap 
         overflow-hidden gap-y-1 md:gap-y-1 lg:gap-y-20  grid-cols-1 md:grid-cols-2  p-4 lg:mt-10'>
            { projects.map(
                ({id, title , des , img , iconLists, link})=>(
                         <div key={id} className='col-span-1 w-full relative  py-8 min-h-[420px] pb-8 '>
